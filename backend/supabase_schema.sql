...
\restrict POscQTXwiuKmcPguCxvH19hhgIQEDgbflsRqAh7tonfu22pbenA4wLVSAsGoojh
...
--
-- Name: borrow_status; Type: TYPE; Schema: public; Owner: -
--
...
--
-- Name: borrow_records; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: borrow_records borrow_records_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: idx_audit_logs_item; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX idx_audit_logs_item ON public.audit_logs USING btree (item_id);
...
ALTER TABLE ONLY public.audit_logs
    ADD CONSTRAINT audit_logs_item_id_fkey FOREIGN KEY (item_id) REFERENCES public.inventory(id) ON DELETE SET NULL;
...
--
-- Name: borrow_records borrow_records_item_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.borrow_records
    ADD CONSTRAINT borrow_records_item_id_fkey FOREIGN KEY (inventory_id) REFERENCES public.inventory(id) ON UPDATE CASCADE ON DELETE CASCADE;
...
--
-- Name: audit_logs Allow all on audit_logs; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all on audit_logs" ON public.audit_logs TO authenticated, anon USING (true) WITH CHECK (true);


--
-- Name: inventory Allow all on inventory; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow all on inventory" ON public.inventory TO authenticated, anon USING (true) WITH CHECK (true);


--
-- Name: audit_logs Allow insert for service or authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow insert for service or authenticated users" ON public.audit_logs FOR INSERT TO authenticated, anon WITH CHECK (true);


--
-- Name: users Allow public registration; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow public registration" ON public.users FOR INSERT TO authenticated, anon WITH CHECK (true);


--
-- Name: borrow_records Allow public/authenticated insert; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow public/authenticated insert" ON public.borrow_records TO authenticated, anon USING (true) WITH CHECK (true);


--
-- Name: audit_logs Allow select for authenticated users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow select for authenticated users" ON public.audit_logs FOR SELECT TO authenticated USING (true);


--
-- Name: users Allow select users; Type: POLICY; Schema: public; Owner: -
--

CREATE POLICY "Allow select users" ON public.users FOR SELECT TO authenticated, anon USING (true);
...
--
-- Name: borrow_records; Type: ROW SECURITY; Schema: public; Owner: -
--
...
\unrestrict POscQTXwiuKmcPguCxvH19hhgIQEDgbflsRqAh7tonfu22pbenA4wLVSAsGoojh
